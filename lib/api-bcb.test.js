...
test('getURL', () => {
    const url = api.getUrl('URL')
    expect(url).toBe("https://olinda.bcb.gov.br/olinda/servico/PTAX/versao/v1/odata/CotacaoDolarDia(dataCotacao=@dataCotacao)?@dataCotacao=%27URL%27&$top=100&$format=json&$select=cotacaoCompra,cotacaoVenda,dataHoraCotacao")
})
